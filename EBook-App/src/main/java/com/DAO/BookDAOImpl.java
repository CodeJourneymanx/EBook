...
public class BookDAOImpl implements BookDAO {
	...
	public List<BookDtls> getNewBook() {
		...
		try {
			...
			String sql ="select * from book_dtls where bookCategory=? and status=? order by book_id DESC";
			PreparedStatement ps=conn.prepareStatement(sql);
			ps.setString(1, "New");
	...
	public boolean oldBookdelete(String email, String cate,int id) {
		...
		try {
			...
			String sql="Delete from book_dtls where bookCategory=? and email=? and book_id=?";
			PreparedStatement ps=conn.prepareStatement(sql);
			ps.setString(1, cate);
			ps.setString(2, email);
			ps.setInt(3, id);
